...
import { LoggerConfig } from './app/loggerConfig';
...
function entry() {
  ...
  const loggerConfig = new LoggerConfig("D:\\project\\homework\\waterball-design-pattern-course-2\\4.4-H\\source\\logger.config.json")
